...
export const TASKS: RankingTask[] = [
  ...
  },
  {
    ...
    exampleEd: "A patient signed out as \"intoxicated, sleeping it off\" has been on the board four hours, and you notice you have walked past the room twice without looking in. Recognizing that you have anchored on the handoff label, name what it would take to change your mind.",
